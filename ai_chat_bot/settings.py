...
SECRET_KEY = 'django-insecure-cp$(l^2zj5)8*_v58@8#aw_4(@ws(_kxahm)$zr&b68l!o8ov='
...
if ENVIRONMENT == PROD:
    DATABASES = {
        'default': {
            ...
            'NAME': 'ai_chat_bot',
            'USER': 'ai_chat_botuser',
            'PASSWORD': 'jhbasIUH73G$8#',
            'HOST': 'localhost',
            'PORT': 5432,
        }
    }
...
CRONJOBS = [
    ('0 6 * * *', 'telegram.cron.send_story_to_all_memberships'),  # 6am UTC = 8am Swiss
    ('0 11 * * *', 'telegram.cron.send_story_to_all_memberships'),  # 11am UTC = 1pm Swiss
    ('0 16 * * *', 'telegram.cron.send_story_to_all_memberships'),  # 4pm UTC = 6pm Swiss
]
